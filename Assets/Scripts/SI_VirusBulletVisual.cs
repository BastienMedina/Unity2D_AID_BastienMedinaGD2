...
// Script autonome de visuel pour la balle ennemie
public class SI_VirusBulletVisual : MonoBehaviour
{
    // Couleur rouge vif de la balle ennemie
    ...
    [SerializeField] private float _scaleY = 0.25f;
    ...
    // Initialise le visuel de la balle ennemie rouge
    private void Awake() =>
